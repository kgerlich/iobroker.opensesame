...
gulp.task('rename', function ()  {
    var newname;
    var author = 'Klaus Gerlicher';
    var email  = 'klaus@klausgerlicher.de';
    ...
    if (!newname) {
        console.log('Please write the new opensesame name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/opensesame.png')) {
        fs.renameSync(__dirname + '/admin/opensesame.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/opensesame.html')) {
        fs.renameSync(__dirname + '/widgets/opensesame.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/opensesame/js/opensesame.js')) {
        fs.renameSync(__dirname + '/widgets/opensesame/js/opensesame.js', __dirname + '/widgets/opensesame/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/opensesame')) {
        fs.renameSync(__dirname + '/widgets/opensesame',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /opensesame/g,
        ...
        {
            match: /opensesame/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'opensesame'
        },
        {
            match: /Klaus Gerlicher/g,
            replacement: author
        },
        {
            match: /klaus@klausgerlicher.de/g,
            replacement: email
        }
    ];
    var files = [
